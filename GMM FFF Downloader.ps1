function Sync-Playlist {
    param(
        [string]$PlaylistUrl = "https://www.youtube.com/playlist?list=PLJ49NV73ttrs67L-YJjl0UGF1vsWC7tH8",
        [string]$OutputDir = "E:\Plex Server\TV Programs\GMM Frozen vs Fast vs Fancy Food (2008)\Season 01",
        [string]$LogDir = "E:\Plex Server\TV Programs\GMM Frozen vs Fast vs Fancy Food (2008)\Logs",
    ...
    try {
        & yt-dlp.exe `
            ...
            --output "GMM Frozen vs Fast vs Fancy Food - S01E%(playlist_index)02d - %(title)s.%(ext)s" `
            $PlaylistUrl
