function Sync-Playlist {
    param(
        [string]$PlaylistUrl = "https://www.youtube.com/playlist?list=PLJ49NV73ttrt60yAQUx-WoaQM3-MksNE3",
        [string]$OutputDir = "E:\Plex Server\TV Programs\GMM Gut Check (2008)\Season 01",
        [string]$LogDir = "E:\Plex Server\TV Programs\GMM Gut Check (2008)\Logs",
    ...
    try {
        & yt-dlp.exe `
            ...
            --output "GMM Gut Check - S01E%(playlist_index)02d - %(title)s.%(ext)s" `
            $PlaylistUrl
