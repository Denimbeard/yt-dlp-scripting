function Sync-Playlist {
    param(
        [string]$PlaylistUrl = "https://www.youtube.com/playlist?list=PLJ49NV73ttrvzyYLLkhoyqe51ptzxCROA",
        [string]$OutputDir = "E:\Plex Server\TV Programs\GMM International Taste Tests (2008)\Season 01",
        [string]$LogDir = "E:\Plex Server\TV Programs\GMM International Taste Tests (2008)\Logs",
    ...
    try {
        & yt-dlp.exe `
            ...
            --output "GMM International Tastes Tests - S01E%(playlist_index)02d - %(title)s.%(ext)s" `
            $PlaylistUrl
